...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : RELAY_Pin LED_Pin EN10_Pin EN3V8_Pin */
  GPIO_InitStruct.Pin = RELAY_Pin|LED_Pin|EN10_Pin|EN3V8_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : LTE_PWR_Pin LTE_RST_Pin */
  GPIO_InitStruct.Pin = LTE_PWR_Pin|LTE_RST_Pin;
