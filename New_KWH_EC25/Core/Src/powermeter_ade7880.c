...
float OFFS_IRMSR=0.153779841998976, OFFS_IRMSS=0.153779841998976, OFFS_IRMST=0.153779841998976, OFFS_IRMSN;
...
void ADE7880_Config(void)
{
	...
	else
	{
		...
		// Jika konfigurasi eror, maka ulangi lagi dari awal
		Retry_ADE7880_Config();
	}
}
...
//	*pf_R=A_PF/32768.0;
	...
	ADE7880_Read_Result1 = ADE7880_Read16();
	ADE7880_CS_SET(ADE7880_CS_PIN);
	FREQ_A=(int)(2560000/ADE7880_Read_Result1);
	*freq_R=FREQ_A;	
	*freq_R/=10.0;
...
//	*pf_S=B_PF/32768.0;
	...
	ADE7880_Read_Result1 = ADE7880_Read16();
	ADE7880_CS_SET(ADE7880_CS_PIN);
	FREQ_B=(int)(2560000/ADE7880_Read_Result1);
	*freq_S=FREQ_B;	
	*freq_S/=10.0;
...
//	*pf_T=C_PF/32768.0;
	...
	ADE7880_Read_Result1 = ADE7880_Read16();
	ADE7880_CS_SET(ADE7880_CS_PIN);
	FREQ_C=(int)(2560000/ADE7880_Read_Result1);
	*freq_T=FREQ_C;	
	*freq_T/=10.0;
}
